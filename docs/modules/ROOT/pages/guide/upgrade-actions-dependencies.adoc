...
1. Check the Action https://docs.openzeppelin.com/defender/v2/module/actions#environment[dependencies latest versions, window=_blank] and search for any breaking changes in your Action code.
...
3. Test the Action code. A safe approach to do this:
  ...
  b. If your action sends relayer transactions using https://docs.openzeppelin.com/defender/v2/sdk[defender-sdk, window=_blank] (or any other Defender legacy package), validate that it works by connecting a testnet relayer with your action.
