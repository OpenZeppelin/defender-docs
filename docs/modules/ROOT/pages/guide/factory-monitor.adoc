...
* The Action makes use of the https://www.npmjs.com/package/@openzeppelin/defender-sdk[`defender-sdk`, window=_blank] to add the address of the newly created contract to the xref:settings.adoc#address-book[address book] for easier monitoring.
