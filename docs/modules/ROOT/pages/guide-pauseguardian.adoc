...
First, sign up for https://defender.openzeppelin.com[Defender] and ensure the EOA used for contract deployment is funded with Sepolia ETH (https://www.alchemy.com/faucets/ethereum-sepolia[via a faucet]).
