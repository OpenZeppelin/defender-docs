...
* *General*
** Feature: Implemented network-based filtering for transaction proposals.
** Fix: Fixed an issue where the Relayer side drawers occasionally triggered console errors.
** Fix: Resolved the issue of duplicate form fields in the "Create Private Networks" feature.
** Fix: Fixed an issue with conflicting transactions when creating a multisig proposal.
** Fix: Validate monitor names.
