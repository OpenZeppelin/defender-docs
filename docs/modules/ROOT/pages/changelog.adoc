...
* *General*
** Fix: Resolved an issue where UI components did not refresh after subscribing to a paid subscription, preventing resource creation when exceeding quota until the page is manually refreshed.
...
** Fix: Solved issue where pausing and unpausing notification channels didn't always work.
