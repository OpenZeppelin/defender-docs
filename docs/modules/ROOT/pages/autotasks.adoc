...
List of available notification channels that could be used can easily be found on Autotask Create/Update Code screens under Code editor by pressing on link `Which Notification channels can be used?`
