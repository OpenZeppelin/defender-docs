...
You can create *Notification Channels* attached to the Monitor alerts for getting notified about the on-chain events across many channels, see more about how to create and configure them in xref:settings/notification-channels.adoc[this section].
