...
NOTE: It is not recommended to use https://www.npmjs.com/package/defender-sentinel-client[defender-sentinel-client] npm package in browser environment as sensitive keys would be exposed publicly.
