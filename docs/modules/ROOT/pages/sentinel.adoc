...
=== Contract Sentinel
Use a Sentinel whenever you need to know about or respond to transactions and forta alerts involving your smart contracts or other smart contracts you need to monitor.  Your Sentinel will watch every transaction and forta alert and send the ones you care about to your notification methods of choice.
...
=== Forta Sentinel
Use a Forta Sentinel whenever you need to know about or respond to Forta alerts involving smart contracts or Forta Agents you want to monitor.  Your Sentinel will watch every Forta Alert related to the Agents your Addresses you specified and send the Alerts you care about to your notification methods of choice.

* *Monitor* specific Forta Agents or Contract Addresses
* *Alert* when re-entrancy is detected or unusually high gas
* *Respond* to Alerts by executing *Autotask* logic when key events happen 
* *Integrate* with your *existing tools* through slack, telegram, discord, email or custom *Autotask* integration
  ...
  "events": [
    {
      "alert": {                            // Forta Alert 
        ...
        "network": "null",                  // specifies which network the transaction was mined
        "protocol": "ethereum",             // name of protocol being reported on e.g. "aave", defaults to "ethereum"
        "scanner_count": 1,
