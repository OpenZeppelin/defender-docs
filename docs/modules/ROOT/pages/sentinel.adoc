...
Please see https://support.atlassian.com/opsgenie/docs/create-a-default-api-integration/ to configure an Opsgenie API integration that can create alerts.
...
* *Alias* Client-defined identifier of the alert, that is also the key element of https://support.atlassian.com/opsgenie/docs/what-is-alert-de-duplication/[Alert De-Duplication] (512 characters)
* *Priority* Priority level of the alert. Possible values are P1, P2, P3, P4 and P5. Default value is P3	
* *Entity* Entity field of the alert that is generally used to specify which domain alert is related to (512 characters)
* *Actions*	Custom actions that will be available for the alert (10 x 50 characters)
* *Note* Additional note that will be added while creating the alert (25000 characters)
* *Details* Map of key-value pairs to use as custom properties of the alert.	8000 characters in total
* *Tags* Tags of the alert (20 x 50 characters)

* *Source* Source field of the alert. Default value is IP address of the incoming request (100 characters)
* *User* Display name of the request owner (100 characters)
