...
On the right side of the conditions form, there is a "Test Sentinel conditions" tool.  This allows you to search for transactions that match the Sentinel's conditions across a range of blocks.
