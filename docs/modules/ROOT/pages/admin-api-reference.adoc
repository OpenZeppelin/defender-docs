...
NOTE: It is not recommended to use https://www.npmjs.com/package/defender-admin-client[defender-admin-client] npm package in browser environment as sensitive keys would be exposed publicly.
