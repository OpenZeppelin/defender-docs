...
NOTE: It is not recommended to use https://www.npmjs.com/package/defender-autotask-client[defender-autotask-client] npm package in browser environment as sensitive keys would be exposed publicly.
