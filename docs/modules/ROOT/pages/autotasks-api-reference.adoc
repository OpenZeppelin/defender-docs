...
[[update-env-var-endpoint]]
== Update Environment Variables Endpoint

Using the `@openzeppelin/defender-autotask-client`, you can call the `updateEnvironmentVariables` endpoint as such:
