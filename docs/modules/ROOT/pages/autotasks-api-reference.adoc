...
NOTE: You can include multiple files in the bundle, as long as the bundle does not exceed 5mb in size, and you include an `index.js` at the root of the zip file to act as entrypoint.
