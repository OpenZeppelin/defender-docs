...
* `EIP1559Pricing`: A boolean indicating the default behavior of the transactions sent by the relayer. If true, transactions will be priced as EIP1559, otherwise, as legacy transactions.
