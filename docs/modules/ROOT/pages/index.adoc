...
If you want access to Mainnet, xDai, BSC, Fantom, Fuse, Matic, Avalanche, Celo, or Abritrum, or to increase any of the quota limits from the free plan, you can upgrade your plan to Team or Individual in the Account Plan menu in the top-right menu in Defender.
