...
IMPORTANT: Defender 1.0 is now deprecated in favor of Defender 2.0. Learn how to migrate xref:migration.adoc[here]! *On June 1st 2024, you will no longer have access to Defender 1.0 UI and API*.
