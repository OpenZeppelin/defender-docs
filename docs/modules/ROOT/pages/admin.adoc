...
The deployment uses a vanilla instance of the https://docs.openzeppelin.com/contracts/4.x/api/governance#TimelockController[TimelockController contract V4.X provided by the OpenZeppelin Contracts library].
