...
A _batch proposal_ is a call to multiple functions from different contracts. It allows you to atomically execute multiple actions in a single transaction.
